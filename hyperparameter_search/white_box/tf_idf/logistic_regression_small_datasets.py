...
"""
Search space for small datasets such as PAN-14 and PAN-17
"""
...
if __name__ == "__main__":
    ...
    outputfile_metadata = f"log_reg_bl_{data_name}_metadata.json"
    model_and_vectorizer_file = f"log_reg_bl_{data_name}_best_model.json"
    ...
    with parallel_backend("loky"):  # default is loky, single-host, process-based parallelism
        ...
        with open(outputfile_metadata, "w", encoding="utf-8") as f:
