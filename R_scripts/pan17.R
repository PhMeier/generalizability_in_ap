...
pan17 <- 'path_to_pan17_train_file\\train_pan_17_stratified.tsv'

# Read in the data
train <- read.table(file = pan17,
...
# alpha = 1 is pure LASSO (L1 Penalty)
# alpha = 0 is Ridge (L2 penalty)
# alpha 0.5 is Elastic NEt (50/50)
